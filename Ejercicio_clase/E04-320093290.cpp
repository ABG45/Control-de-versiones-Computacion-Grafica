/*Practica 4: Modelado Jerarquico - ROVER  ***VERSION 1***
Contiene: CABINA + BASE + DOS LLANTAS DELANTERAS + BRAZO CON PINZA

Se implementa el uso de matrices auxiliares para almacenar transformaciones
geometricas que se heredan entre instancias para que esten unidas.
...
CONTROLES
  ...
  --- LLANTAS ---
  4 / 7           : seleccionar llanta delantera cerca / lejos
  K               : girar la llanta seleccionada
  L               : girar las llantas al mismo tiempo
  --- SUSPENSION ---
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		for (int lado = 1; lado >= -1; lado -= 2)
		{
			...
			int iLlanta = (lado == 1) ? 0 : 3;	//0 = delantera cerca, 3 = delantera lejos
